...
public class ProductPosListAdapter extends BaseAdapter{
    ...
    public ProductPosListAdapter(Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            convertView = layoutinflater.inflate(R.layout.list_item_pos_product, parent, false);
